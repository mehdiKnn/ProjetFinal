    ...
    <div class="row mt-4">
        ...
        <section class="col-9">
            <div class="pb-4 d-flex justify-content-between">
                ...
                <a class="btn btn-primary" href="?page=admin&param=event_form">Ajouter un événements</a>
            </div>
            ...
            <table class="table table-striped">
                ...
                <?php foreach($eventsList as $event): ?>
                    <tr>
                        ...
                        <td><?php echo ($event['published'] == "1" ? "oui" :  "non"); ?></td>
                        <td>
                            <a href="?page=admin&param=event_form&event_id=<?php echo $event['id']?>" class="btn btn-warning">Modifier</a>
                            <a onclick="return confirm('Are you sure?')" href="user-list.php?user_id=<?php echo $event['id']?>&amp;action=delete" class="btn btn-danger">Supprimer</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
