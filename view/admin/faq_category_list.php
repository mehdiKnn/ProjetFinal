    ...
    <div class="row mt-4">
        ...
        <section class="col-9">
            <div class="pb-4 d-flex justify-content-between">
                <h4>Liste des catégories FAQ</h4>
                <a class="btn btn-primary" href="?page=admin&param=faq_category_form">Ajouter une catégorie FAQ</a>
            </div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                <?php foreach($faqCategoryList as $faq): ?>
                    <tr>
                        <th><?php echo $faq['id']?></th>
                        <td><?php echo $faq['name']?></td>
                        <td>
                            <a href="?page=admin&param=faq_category_form&faq_category_id=<?php echo $faq['id']?>" class="btn btn-warning">Modifier</a>
                            <a onclick="return confirm('Are you sure?')" href="?page=admin&param=faq_category_list&faq_category_id=<?php echo $faq['id']?>&amp;action=delete" class="btn btn-danger">Supprimer</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
