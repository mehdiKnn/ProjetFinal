...
<div class="container">
    <div class="row mt-4">
        ...
        <section class="col-9">
            ...
            <?php endif; ?>
            <form action="?page=admin&param=faq_form" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="question">Question :</label>
                    <textarea class="form-control" rows="2" type="text" placeholder="Question" name="question" id="question"><?php if (isset($faqInfo)): ?><?= htmlentities($faqInfo['question']); ?><?php endif; ?></textarea>
                </div>
                <div class="form-group">
                    <label for="answer">Réponse :</label>
                    <textarea class="form-control" rows="2" type="text" placeholder="Réponse" name="answer" id="answer"><?php if (isset($faqInfo)): ?><?= htmlentities($faqInfo['answer']); ?><?php endif; ?></textarea>
                </div>
                <div class="form-group">
                ...
                <input type="hidden" name="id" value="<?php if (isset($_GET['faq_id'])) {
                    echo $faqInfo['id'];
                } ?>">
