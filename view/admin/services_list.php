    ...
    <div class="row mt-4">
       ...
       <section class="col-9">
            <div class="pb-4 d-flex justify-content-between">
                ...
                <a class="btn btn-primary" href="?page=admin&param=service_form">Ajouter un service</a>
            </div>
            ...
            <table class="table table-striped">
                ...
                <?php foreach($serviceList as $service): ?>
                    <tr>
                        ...
                        <td><?php echo $service['catName']?></td>
                        <td>
                            <a href="?page=admin&param=service_form&service_id=<?php echo $service['id']?>" class="btn btn-warning">Modifier</a>
                            <a onclick="return confirm('Are you sure?')" href="?page=admin&param=services_list&service_id=<?php echo $service['id']?>&amp;action=delete" class="btn btn-danger">Supprimer</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
